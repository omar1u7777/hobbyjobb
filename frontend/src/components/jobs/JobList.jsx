...
export default function JobList({ jobs, loading, error }) {
  ...
  if (!jobs?.length) return <div style={{ textAlign: 'center', padding: '60px 20px', color: 'var(--muted)' }}><div style={{ fontSize: 48, marginBottom: 12 }}>🔍</div><p style={{ fontWeight: 600 }}>Inga jobb hittades</p></div>;
